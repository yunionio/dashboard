    ...
    <div class="dashboard-card-wrap">
      ...
      <div class="dashboard-card-body align-items-center">
        ...
        <div class="flex-fill ml-4">
          ...
          <div class="d-flex bottomborder-box align-items-end" :style="itemStyle">
            <div class="label-unit">{{ unUseLabel }}<a-tooltip v-if="showTips" class="ml-1" :title="$t('dashboard.un_usage_tips')"><a-icon type="question-circle" /></a-tooltip></div>
          ...
          <div class="d-flex bottomborder-box align-items-end" :style="itemStyle">
            <div class="label-unit">{{ $t('dashboard.text_181') }}<a-tooltip v-if="showTips" class="ml-1" :title="$t('dashboard.all_usage_tips')"><a-icon type="question-circle" /></a-tooltip></div>
