  ...
  <div v-if="!loading">
    ...
    <div>
      ...
      <a-row v-if="dashboardId">
        <dashboard-cards :selectable="true" @chose_first_panel="chose_first_panel" @chose_panels="chose_panel" :focusPanelId="focusPanelId" :readOnly="true" :id="dashboardId" :extraParams="extraParams" :create-chart="createChart"  :edit-chart="editChart" />
      </a-row>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getData () {
      this.dashboardId = this.form.dashboardId || null
      this.focusPanelId = this.form.panelId || this.focusPanelId
      this.dashboardId ? this.fetchDashboards() : this.switchDashboard()
    },
    chose_panel (val) {
      this.focusPanelId = val.id
      this.focusPanelName = val.name
    },
    chose_first_panel (id) {
      this.focusPanelId = this.focusPanelId || id
    },
