...
export default {
    ...
    return {
      list: this.$list.createList(this, {
        ...
        fetchDataCb: async response => {
          await this.enrichRowsWithAiproxyLlmLinks(response, { withDeployment: true, withInstance: true })
        },
      }),
      exportDataOptions: {
        items: [
  ...
  activated () {
    this.syncAiproxyLlmLinkNamesForList({ withDeployment: true, withInstance: true })
  },
  methods: {
    getParam () {
      return {
