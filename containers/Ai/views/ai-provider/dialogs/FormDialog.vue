  ...
  <base-dialog :width="720" @cancel="cancelDialog">
    ...
    <div slot="body">
      <a-form-model ref="form" :model="form" :rules="rules" :label-col="{ span: 5 }" :wrapper-col="{ span: 17 }">
        ...
        <a-form-model-item :label="$t('aice.aiproxy.llm_deployment_id')" prop="llm_deployment_id">
          <a-input v-model="form.llm_deployment_id" />
        </a-form-model-item>
        <a-form-model-item :label="$t('aice.aiproxy.llm_id')" prop="llm_id">
          <a-input v-model="form.llm_id" />
        </a-form-model-item>
      </a-form-model>
    </div>
    <div slot="footer">
  ...
  methods: {
    buildPayload () {
      ...
      const payload = {
        ...
        llm_id: this.form.llm_id || undefined,
      }
