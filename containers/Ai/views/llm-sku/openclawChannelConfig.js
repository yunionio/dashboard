...
export const OPENCLAW_CHANNEL_SECTIONS = [
  ...
  },
  {
    ...
    vars: [
      { envKey: 'DISCORD_BOT_TOKEN', descriptionKey: 'aice.openclaw.channel.env.DISCORD_BOT_TOKEN', defaultValue: '' },
      { envKey: 'DISCORD_DM_POLICY', descriptionKey: 'aice.openclaw.channel.env.DISCORD_DM_POLICY', defaultValue: 'pairing' },
      { envKey: 'DISCORD_DM_ALLOW_FROM', descriptionKey: 'aice.openclaw.channel.env.DISCORD_DM_ALLOW_FROM', defaultValue: '' },
      { envKey: 'DISCORD_GROUP_POLICY', descriptionKey: 'aice.openclaw.channel.env.DISCORD_GROUP_POLICY', defaultValue: 'allowlist' },
      { envKey: 'DISCORD_REPLY_TO_MODE', descriptionKey: 'aice.openclaw.channel.env.DISCORD_REPLY_TO_MODE', defaultValue: 'off' },
      { envKey: 'DISCORD_CHUNK_MODE', descriptionKey: 'aice.openclaw.channel.env.DISCORD_CHUNK_MODE', defaultValue: 'length' },
      { envKey: 'DISCORD_TEXT_CHUNK_LIMIT', descriptionKey: 'aice.openclaw.channel.env.DISCORD_TEXT_CHUNK_LIMIT', defaultValue: '2000' },
      { envKey: 'DISCORD_MAX_LINES_PER_MESSAGE', descriptionKey: 'aice.openclaw.channel.env.DISCORD_MAX_LINES_PER_MESSAGE', defaultValue: '17' },
      { envKey: 'DISCORD_MEDIA_MAX_MB', descriptionKey: 'aice.openclaw.channel.env.DISCORD_MEDIA_MAX_MB', defaultValue: '8' },
      { envKey: 'DISCORD_HISTORY_LIMIT', descriptionKey: 'aice.openclaw.channel.env.DISCORD_HISTORY_LIMIT', defaultValue: '20' },
      { envKey: 'DISCORD_DM_HISTORY_LIMIT', descriptionKey: 'aice.openclaw.channel.env.DISCORD_DM_HISTORY_LIMIT', defaultValue: '' },
      { envKey: 'DISCORD_REACTION_NOTIFICATIONS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_REACTION_NOTIFICATIONS', defaultValue: 'own' },
      { envKey: 'DISCORD_ALLOW_BOTS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ALLOW_BOTS', defaultValue: 'false' },
      { envKey: 'DISCORD_MESSAGE_PREFIX', descriptionKey: 'aice.openclaw.channel.env.DISCORD_MESSAGE_PREFIX', defaultValue: '' },
      { envKey: 'DISCORD_ACTIONS_REACTIONS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_REACTIONS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_STICKERS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_STICKERS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_EMOJI_UPLOADS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_EMOJI_UPLOADS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_STICKER_UPLOADS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_STICKER_UPLOADS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_POLLS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_POLLS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_PERMISSIONS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_PERMISSIONS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_MESSAGES', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_MESSAGES', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_THREADS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_THREADS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_PINS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_PINS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_SEARCH', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_SEARCH', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_MEMBER_INFO', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_MEMBER_INFO', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_ROLE_INFO', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_ROLE_INFO', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_CHANNEL_INFO', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_CHANNEL_INFO', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_CHANNELS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_CHANNELS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_VOICE_STATUS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_VOICE_STATUS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_EVENTS', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_EVENTS', defaultValue: 'true' },
      { envKey: 'DISCORD_ACTIONS_ROLES', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_ROLES', defaultValue: 'false' },
      { envKey: 'DISCORD_ACTIONS_MODERATION', descriptionKey: 'aice.openclaw.channel.env.DISCORD_ACTIONS_MODERATION', defaultValue: 'false' },
    ],
  },
  {
    sectionKey: 'telegram',
    ...
    vars: [
      { envKey: 'TELEGRAM_BOT_TOKEN', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_BOT_TOKEN', defaultValue: '' },
      { envKey: 'TELEGRAM_DM_POLICY', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_DM_POLICY', defaultValue: 'pairing' },
      { envKey: 'TELEGRAM_ALLOW_FROM', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_ALLOW_FROM', defaultValue: '' },
      { envKey: 'TELEGRAM_GROUP_POLICY', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_GROUP_POLICY', defaultValue: 'allowlist' },
      { envKey: 'TELEGRAM_GROUP_ALLOW_FROM', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_GROUP_ALLOW_FROM', defaultValue: '' },
      { envKey: 'TELEGRAM_REPLY_TO_MODE', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_REPLY_TO_MODE', defaultValue: 'first' },
      { envKey: 'TELEGRAM_CHUNK_MODE', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_CHUNK_MODE', defaultValue: 'length' },
      { envKey: 'TELEGRAM_TEXT_CHUNK_LIMIT', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_TEXT_CHUNK_LIMIT', defaultValue: '4000' },
      { envKey: 'TELEGRAM_STREAM_MODE', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_STREAM_MODE', defaultValue: 'partial' },
      { envKey: 'TELEGRAM_LINK_PREVIEW', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_LINK_PREVIEW', defaultValue: 'true' },
      { envKey: 'TELEGRAM_MEDIA_MAX_MB', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_MEDIA_MAX_MB', defaultValue: '5' },
      { envKey: 'TELEGRAM_REACTION_NOTIFICATIONS', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_REACTION_NOTIFICATIONS', defaultValue: 'own' },
      { envKey: 'TELEGRAM_REACTION_LEVEL', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_REACTION_LEVEL', defaultValue: 'minimal' },
      { envKey: 'TELEGRAM_INLINE_BUTTONS', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_INLINE_BUTTONS', defaultValue: 'allowlist' },
      { envKey: 'TELEGRAM_ACTIONS_REACTIONS', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_ACTIONS_REACTIONS', defaultValue: 'true' },
      { envKey: 'TELEGRAM_ACTIONS_STICKER', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_ACTIONS_STICKER', defaultValue: 'false' },
      { envKey: 'TELEGRAM_PROXY', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_PROXY', defaultValue: '' },
      { envKey: 'TELEGRAM_WEBHOOK_URL', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_WEBHOOK_URL', defaultValue: '' },
      { envKey: 'TELEGRAM_WEBHOOK_SECRET', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_WEBHOOK_SECRET', defaultValue: '' },
      { envKey: 'TELEGRAM_WEBHOOK_PATH', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_WEBHOOK_PATH', defaultValue: '/telegram-webhook' },
      { envKey: 'TELEGRAM_MESSAGE_PREFIX', descriptionKey: 'aice.openclaw.channel.env.TELEGRAM_MESSAGE_PREFIX', defaultValue: '' },
    ],
  },
  // 以下渠道暂不展示，需要时取消注释即可
  // {
