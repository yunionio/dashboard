  ...
  return {
    ...
    slots: {
      default: ({ row }, h) => {
        ...
        return [
          <list-body-cell-wrap copy hideField={true} field='ai_model_id' row={row} message={text}>
            <side-page-trigger onTrigger={() => vm.handleOpenAiModelSidepage(id, row.ai_provider_id)}>{text}</side-page-trigger>
          </list-body-cell-wrap>,
        ]
      },
    },
  ...
  return {
    ...
    slots: {
      default: ({ row }, h) => {
        ...
        if (!id) return '-'
        return [
          <list-body-cell-wrap copy hideField={true} field='ai_proxy_node_id' row={row} message={id}>
            <side-page-trigger onTrigger={() => vm.handleOpenAiProxyNodeSidepage(id)}>{id}</side-page-trigger>
          </list-body-cell-wrap>,
        ]
      },
    },
