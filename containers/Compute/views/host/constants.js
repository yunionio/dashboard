...
export const HYSMI_OPTS = [
  {
    name: 'temperature_gpu',
    label: i18n.t('compute.metric.hysmi_temperature_gpu'),
    as: i18n.t('compute.metric.hysmi_temperature_gpu'),
    seleteItem: 'temperature_gpu',
    fromItem: 'hysmi',
    groupBy: ['dcu'],
    unit: '',
  ...
  {
    name: 'power_draw',
    label: i18n.t('compute.metric.hysmi_power_draw'),
    as: i18n.t('compute.metric.hysmi_power_draw'),
  ...
  {
    name: 'utilization_gpu',
    label: i18n.t('compute.metric.hysmi_utilization_gpu'),
    as: i18n.t('compute.metric.hysmi_utilization_gpu'),
    seleteItem: 'utilization_gpu',
    fromItem: 'hysmi',
    groupBy: ['dcu'],
    unit: '%',
  ...
  {
    name: 'utilization_memory',
    label: i18n.t('compute.metric.hysmi_utilization_memory'),
    as: i18n.t('compute.metric.hysmi_utilization_memory'),
    seleteItem: 'utilization_memory',
    fromItem: 'hysmi',
    groupBy: ['dcu'],
    unit: '%',
  ...
  {
    name: 'utilization_encoder',
    label: i18n.t('compute.metric.hysmi_utilization_encoder'),
    as: i18n.t('compute.metric.hysmi_utilization_encoder'),
    seleteItem: 'utilization_encoder',
    fromItem: 'hysmi',
    groupBy: ['dcu'],
    unit: '%',
  ...
  {
    name: 'utilization_decoder',
    label: i18n.t('compute.metric.hysmi_utilization_decoder'),
    as: i18n.t('compute.metric.hysmi_utilization_decoder'),
    seleteItem: 'utilization_decoder',
    fromItem: 'hysmi',
    groupBy: ['dcu'],
    unit: '%',
