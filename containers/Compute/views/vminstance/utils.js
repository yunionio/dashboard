...
const actionEableMap = {
  rebuildRoot: {
    ...
    brand: {
      ...
      huaweicloudstack: ['ready', 'rebuild_root_fail'],
      openstack: ['ready'],
      zstack: ['ready'],
      dstack: ['ready'],
      ucloud: ['ready'],
  ...
  'IP SSH': {
    ...
    brand: {
      ...
      huaweicloudstack: false, // 暂时网络未打通
      openstack: ['running'],
      zstack: false,
      dstack: false,
      ucloud: false,
  ...
  createSnapshot: {
    ...
    brand: {
      ...
      huaweicloudstack: ['running', 'ready'],
