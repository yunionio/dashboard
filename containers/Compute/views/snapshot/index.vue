<template>
  <div>
    <page-header :title="$t('compute.text_101')" :tabs="cloudEnvOptions" :current-tab.sync="cloudEnv">
  ...
  methods: {
    getStatusOpts (data) {
      ...
      const statusOpts = [
        ...
        { title: this.$t('status.snapshot.ready'), type: 'ready', num: ready?.total_count || 0 },
