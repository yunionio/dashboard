      ...
      <template v-slot:content>
        <div class="notify-wrap">
          <div class="notify-header d-flex align-items-center">
            <div class="flex-fill title">消息中心</div>
            <a v-if="showMore && $appConfig.isPrivate" @click="toMore">查看更多</a>
          </div>
            ...
            <ul class="notify-list" v-else>
              <li
                ...
                <div class="item-header d-flex">
                  <div class="item-header-type">服务消息</div>
...
export default {
  ...
  methods: {
    ...
    toMore () {
      window.location.href = this.$appConfig.v1Perfix + '/notify'
    },
  },
}
</script>
