    ...
    initApplyInternalResourceInfo () {
      const applyInternalResourceInfo = {
        ...
        slots: {
          default: ({ row }, h) => {
            return [
              <ApplyInternalResourceInfo resource="historic-process-instances" variables={ this.variables } local_variables={ this.local_variables } data={ this.data } columns={ this.workflowColumns } />,
            ]
          },
        },
      }
