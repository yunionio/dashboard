...
const FEATURE_MENUS = {
  ...
  ai: {
    ceMenus: ['cloudregion', 'app-llm', 'app-llm-sku', 'app-llm-image', 'agent-llm-image', 'llm', 'llm-sku', 'llm-instantmodel', 'llm-image', 'llm-deployment', 'ai-virtual-key', 'ai-routing', 'ai-provider', 'ai-proxy-node', 'ai-proxy-usage'],
  },
  baremetal: {
