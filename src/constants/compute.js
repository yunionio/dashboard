...
export const IMAGES_TYPE_MAP = {
  ...
  snapshot: { key: 'snapshot', label: i18n.t('dictionary.instance_snapshot'), tooltip: i18n.t('common.instance_snapshot.tooltip') },
  backup: { key: 'backup', label: i18n.t('dictionary.instancebackup'), tooltip: i18n.t('dictionary.instancebackup') },
...
export const STORAGE_TYPES = {
  ...
  [HYPERVISORS_MAP.ctyun.key]: {
    ...
    SAS: {
      label: i18n.t('common.storage.ctyun.sas'),
      key: 'SAS',
      min: 10,
      max: 32768,
      sysMin: 40,
    ...
    SATA: {
      label: i18n.t('common.storage.ctyun.sata'),
      key: 'SATA',
      min: 10,
      max: 32768,
      default: true,
    ...
    'FAST-SSD': {
      label: i18n.t('common.storage.ctyun.fast_ssd'),
      key: 'FAST-SSD',
      min: 10,
      max: 32768,
      default: true,
    ...
    'SSD-genric': {
      label: i18n.t('common.storage.ctyun.ssd_genric'),
      key: 'SSD-genric',
      min: 10,
      max: 32768,
      default: true,
