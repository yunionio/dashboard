...
export const policies = {
  [CATEGORY_KEYS.VMINSTANCE_HIDDEN_MENUS]: [
    ...
    { label: i18n.t('cloudenv.text_354'), value: 'server_perform_syncstatus' },
    ...
    { label: i18n.t('cloudenv.text_519'), value: 'server_perform_change_owner' },
    ...
    { label: i18n.t('cloudenv.server_change_ip'), value: 'server_change_ip' },
    { label: i18n.t('cloudenv.server_detach_nic'), value: 'server_detach_nic' },
  ],
